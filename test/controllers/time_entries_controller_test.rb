...
class TimeEntriesControllerTest < ActionController::TestCase
  ...
  test "should create time_entry" do
    assert_difference('TimeEntry.count') do
      post :create, time_entry: { date: @time_entry.date, hours: @time_entry.hours, project_id: @time_entry.project_id, task_id: @time_entry.task_id, user_id: @time_entry.user_id }
    end
  ...
  test "should update time_entry" do
    patch :update, id: @time_entry, time_entry: { date: @time_entry.date, hours: @time_entry.hours, project_id: @time_entry.project_id, task_id: @time_entry.task_id, user_id: @time_entry.user_id }
    assert_redirected_to time_entry_path(assigns(:time_entry))
  end
